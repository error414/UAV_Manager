      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <CountryDropdown
            ...
            defaultOptionLabel=" "
            className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm"
          />
        </div>
